		...
		<div class="trend-box">
			...
			<ul id="trend_list" class="trending-list" style="display: block;">
				...
				<li class="trend-item"><a href="https://ccsd.net/district/backtoschool/legal-notices.html">
					2024-2025 Back to School Legal Notices</a>
				</li>
				...
				<li class="trend-item"><a href="/district/anti-racism/">Policy 5139 Anti-Racism, Equity, and
						Inclusion</a></li>
			</ul>
		</div>
		<div id="news_box">

		<a href="https://newsroom.ccsd.net/ccsd-superintendent-search-survey-now-available/?utm_source=ccsd&utm_medium=featured_image&utm_campaign=newsroom&utm_content=superintendent_search" id="news_item_1"
				data-item="1" class="current news-item-wrap clearfix" style="top: 0; opacity: 1;text-decoration:none !important;">
				<!-- <div style="position: relative;width:960px;height:425px;"> -->
				<div style="position: relative;">
					<img class="news-img" style="top: 0;"
						src="https://newsroom.ccsd.net/wp-content/uploads/CCSD-Sahara-Exterior-Banner-1.jpg" alt="News Image" />
					<div class="news-copy-wrap" style="top: 255px !important;">

						<div class="news-copy">
							<h3 style="text-decoration:none !important; top:-50px;">CCSD superintendent search survey now available</h3>
						</div>

						<div>
							<a href="https://newsroom.ccsd.net/ccsd-superintendent-search-survey-now-available/?utm_source=ccsd&utm_medium=featured_image&utm_campaign=newsroom&utm_content=superintendent_search" class="more-link" style="margin-top:65px;margin-left:20px">Read more</a>
						</div>
...
<!--
		<div id="news_box">
			<a href="http://newsroom.ccsd.net/ccsd-2024-25-school-year-registration-available-now" id="news_item_1"
				data-item="1" class="current news-item-wrap clearfix" style="top: 0; opacity: 1;">
				<div style="position: relative;">
					<img class="news-img" style="top: 0;"
						src="https://newsroom.ccsd.net/wp-content/uploads/Banner-18.png" alt="News Image" />
					<div class="news-copy-wrap">
						<div class="news-copy">
							<h3>CCSD 2024-25 school year registration available now</h3>
						</div>
					</div>
					<div class="news-shadow"></div>
				</div>
...
-->
	...
	<section>
		...
		<div id="news_story_1">
				<a href="https://ccsd.net/district/backtoschool/weapon-detection.html?utm_source=ccsd&utm_medium=featured_image_button&utm_campaign=back_to_school&utm_content=weapons_detection">
					<div class="story-img">
						<img src="https://ccsd.net/district/backtoschool/assets/images/blog/inner/Pouch2.jpg" alt="News Image"
							height="169" width="310">
					</div>
					<div class="story-headline">
					Focus on Safety: Student cell phone/ID and Weapons Detection System requirements
					</div>
				</a>
			</div>
							<div id="news_story_2">
				<a href="https://newsroom.ccsd.net/ccsd-celebrates-improved-student-attendance/">
					<div class="story-img">
						<img src="https://newsroom.ccsd.net/wp-content/uploads/EveryDayMatters_Banner-1-1.jpg" alt="News Image"
							height="169" width="310">
					</div>
					<div class="story-headline">
...
<!--
						...
						<div id="news_story_3">
				<a href="https://newsroom.ccsd.net/cox-back-to-school-fair/">
					<div class="story-img">
						<img src="https://newsroom.ccsd.net/wp-content/uploads/2024Cox_Banner-01.png" alt="News Image"
							height="169" width="310">
					</div>
					<div class="story-headline">
						Cox Back to School Fair
					</div>
				</a>
			</div>
-->
			...
			<div id="news_story_3">
				<a href="https://newsroom.ccsd.net/mental-wellness-resources-and-support/">
					<div class="story-img">
						<img src="https://newsroom.ccsd.net/wp-content/uploads/Safe-Voice.png" alt="News Image"
							height="169" width="310">
					</div>
					<div class="story-headline">
...
<div align="center" style="margin-top: 40px;">
		<a class="BTSR-notice more-link2" href="https://backtoschool.ccsd.net/"><img src="https://ccsd.net/_static/images/2024-backtoschool.jpg" alt="Back to School" /></a>
	</div>

	<div align="center" style="margin-top:10px;margin-bottom:-35px;padding-bottom:10px;">
		<h2 class="BTSR-notice BTSR-label"><span><a class="BTSR-notice" href="https://ccsd.net/district/backtoschool/legal-notices.html">Back to  School Legal Notices</a></span></h2>

	 </div>
 	<div align="center" style="margin-bottom:20px;height:70px;margin-left: 385px;margin-right: auto;">
	 	<a style="margin-right: 20px;" class="more-link" href="https://ccsd.net/district/backtoschool/assets/pdf/24-25-Back-to-School-Legal-Notices-English.pdf" target="_blank">English</a>
	 	<a  class="more-link" href="https://ccsd.net/district/backtoschool/assets/pdf/24-25-Back-to-School-Legal-Notices-Spanish.pdf" target="_blank">Spanish</a>
		...
		<main id="main_content_wrap">
			...
			<div class="content-full-wrap">
				...
				<div id="card2" class="card-wrapper cards-bottom-row">
					...
					<div class="card-content">
						<div class="card-text">The Clark County School District is seeking highly motivated employees
				...
				<div id="card3" class="card-wrapper">
					...
					<div class="card-content">
						<div class="card-text">Ask <span style="color:#707070;font-weight: 600;">questions.</span><br>
				...
				<div id="card4" class="card-wrapper">
					...
					<div class="card-content">
						<div class="card-text">Get to know your Board of School Trustees and learn about upcoming board
							meetings.</div>
					</div>
				</div>
				...
				<div id="card6" class="card-wrapper cards-bottom-row ">
					...
					<div class="card-content">
						<div class="card-text">SafeVoice is the new statewide reporting system for threats to school and
				...
				<div id="card7" class="card-wrapper">
					<a id="infinite-campus" href="https://ccsd.net/parents/infinite-campus-choice.php">
						<div class="card-image"><img src="/_static/images/newdesign/infinite-campus.jpg" alt="" /></div>
...
-->
				...
				<div id="card8" class="card-wrapper">
					<a id="focus-2024" href="https://ccsd.net/district/superintendent-selection/">
						<div class="card-image"><img src="/_static/images/newdesign/superintendent-selection-search-new.png" alt="" /></div>
						<h2 class="card-title">Superintendent Selection Search</h2>
					</a>
					<div class="card-content">
						<div class="card-text">Learn more about the process of finding the next Superintendent of Schools for the Clark County School District (CCSD).</div>
					</div>
				</div>
