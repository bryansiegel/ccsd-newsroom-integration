...
if ($response === false) {
    ...
    // mail("wordpress-support-user@nv.ccsd.net ", "Left News API From Newsroom is broken", "The Newsroom API is broken for Left News", $headers);
...
$file = '/www/apache/htdocs/ccsd/_includes/api/json/left-news.json';
