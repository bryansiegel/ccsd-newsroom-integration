...
if ($response === false) {
    ...
    // mail("wordpress-support-user@nv.ccsd.net ", "Right News API From Newsroom is broken", "The Newsroom API is broken for Right News", $headers);
...
$file = '/www/apache/htdocs/ccsd/_includes/api/json/right-news.json';
